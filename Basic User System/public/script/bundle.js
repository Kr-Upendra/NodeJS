...
if (loginForm) loginForm.addEventListener("submit", function (e) {
  ...
  (0, _login.login)(loginEmail, loginPassword);
});
if (signupForm) signupForm.addEventListener("submit", function (e) {
  ...
  var signupConfirmPassword = document.querySelector(".signupConfirmPassword").value;
  (0, _signup.signup)(signupUsername, signupEmail, signupPassword, signupConfirmPassword);
});
